...
export function EnhancedTaskCategories() {
  ...
  const categories: Record<string, TaskCategory> = {
    TOP_PRIORITY: {
      ...
      badgeColor: 'bg-destructive/10 dark:bg-destructive/20 text-destructive-foreground',
      minTasks: 3,
    ...
    PRIORITY: {
      ...
      badgeColor: 'bg-accent/10 dark:bg-accent/20 text-accent-foreground',
      minTasks: 3,
    ...
    BONUS: {
      ...
      badgeColor: 'bg-secondary/10 dark:bg-secondary/20 text-secondary-foreground',
      minTasks: 3,
